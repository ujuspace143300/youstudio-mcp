...
- **재생성 결과(2026-08-17)**: 총 561.01s · 컷 52 · 나레 27 · 자막 210(대사 136 · 나레 74) · **G-대사선행 통과(선행 평균 −0.034s · 최대 0.000s · 0.1s 초과 0건)** · 교차 겹침 0 · 나레 큐 무음 0 · 죽은 시간 0.136 · export 게이트 10개 통과 · prproj 자기검증 통과(블롭 210/210, timeline 대조 0). prproj 검증 기대치는 하드코딩을 버리고 **실제 트랙 수를 읽어 맞추도록** 고쳤다.
