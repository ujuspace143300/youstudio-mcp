...
const carry = {
  ...
  selection: rd(W + "/clips/selection.json"), voice: rd(W + "/voice/voice.json"), transcript_utterances: rd(W + "/transcript/transcript.json").utterances, transcript_words: rd(W + "/transcript/transcript.json").words ?? [], transcript_silences: rd(W + "/transcript/transcript.json").silences ?? [], visual: rd(W + "/clips/visual.json"),
};
